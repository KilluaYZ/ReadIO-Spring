package com.pool.readio.gateway.util;
...
public class StpMemberUtil {
     ...
     * @param loginId 账号id
     * @param device 设备类型，填 null 代表不限设备类型
     * @return 此 loginId 的所有登录 SaTerminalInfo
     */
    public static List<SaTerminalInfo> getTokenSignListByLoginId(Object loginId, String device) {
