...
import com.pool.readio.mbg.mapper.SmsFlashPromotionMapper;
import com.pool.readio.mbg.model.SmsFlashPromotion;
import com.pool.readio.mbg.model.SmsFlashPromotionExample;
...
public class SmsFlashPromotionServiceImpl implements SmsFlashPromotionService {
    ...
    public SmsFlashPromotionServiceImpl(SmsFlashPromotionMapper flashPromotionMapper) {
    ...
    public int update(Long id, SmsFlashPromotion flashPromotion) {
        flashPromotion.setId(id.intValue());
        return flashPromotionMapper.updateByPrimaryKey(flashPromotion);
    }

    @Override
    public int delete(Long id) {
        return flashPromotionMapper.deleteByPrimaryKey(id.intValue());
    }
    ...
    public int updateStatus(Long id, Integer status) {
        ...
        flashPromotion.setId(id.intValue());
        flashPromotion.setStatus(status != null && status != 0);
        return flashPromotionMapper.updateByPrimaryKeySelective(flashPromotion);
    }

    @Override
    public SmsFlashPromotion getItem(Long id) {
        return flashPromotionMapper.selectByPrimaryKey(id.intValue());
    }
