...
import com.pool.readio.admin.dto.UmsMenuNode;
import com.pool.readio.mbg.mapper.UmsMenuMapper;
...
public class UmsMenuServiceImpl implements UmsMenuService {
    ...
    public int delete(Long id) {
        return menuMapper.deleteByPrimaryKey(id.intValue());
    }
    ...
    public int updateHidden(Long id, Integer hidden) {
        ...
        umsMenu.setId(id.intValue());
        umsMenu.setHidden(hidden != null && hidden != 0);
        return menuMapper.updateByPrimaryKeySelective(umsMenu);
    }
    ...
    private UmsMenuNode covertMenuNode(UmsMenu menu, List<UmsMenu> menuList) {
        ...
        List<UmsMenuNode> children = menuList.stream()
                .filter(subMenu -> menu.getId() != null && subMenu.getParentId() != null && subMenu.getParentId().equals(menu.getId()))
