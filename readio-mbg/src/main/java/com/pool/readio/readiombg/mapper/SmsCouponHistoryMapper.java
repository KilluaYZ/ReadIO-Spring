...
import com.pool.readio.readiombg.model.SmsCouponHistory;
import com.pool.readio.readiombg.model.SmsCouponHistoryExample;
...
public interface SmsCouponHistoryMapper {
    ...
    SmsCouponHistory selectByPrimaryKey(Integer id);
