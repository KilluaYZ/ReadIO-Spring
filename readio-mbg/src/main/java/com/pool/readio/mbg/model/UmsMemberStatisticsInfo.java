...
public class UmsMemberStatisticsInfo implements Serializable {
    ...
    @Schema(title = "收藏的书籍数量")
    private Integer collectBookNum;
    ...
    public Integer getCollectBookNum() {
        return collectBookNum;
    }

    public void setCollectBookNum(Integer collectBookNum) {
    ...
    public String toString() {
        ...
        sb.append(", collectBookNum=").append(collectBookNum);
